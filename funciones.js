...
const crearContacto = (parentNode, contacto, db) =>{
    ...
    let numerocasaContacto= document.createElement('p')
    ...
    numerocasaContacto.innerHTML =contacto.numero
    ...
    divContacto.appendChild(numerocasaContacto)
    divContacto.appendChild(correoContacto)
    divContacto.appendChild(iconoBorrar)

    parentNode.appendChild(divContacto)
}
const modificarContactos = (db,) =>{}